...
def generate_anonymous_name() -> str:
    ...
    return f"{random.choice(prefixes)}({ip})"
...
【익명 닉네임 생성 규칙】
- 매번 랜덤하게 생성 (예: ㅇㅇ(112.34.56.78), ㅎㅎ(192.168.1.1), 익(10.0.0.1))
- 닉네임 예시: ㅇㅇ(112.34.56.78), ㅎㅎ(192.168.1.1), 익(10.0.0.1), ㄱㄱ(172.16.0.1), ㅂㅂ(220.100.50.25), ㅈㅈ(61.32.105.7)
